 ...
 */
@Service
public class GioneeAccessDecisionManager implements AccessDecisionManager {
	protected static Logger logger = Logger.getLogger(GioneeAccessDecisionManager.class);
