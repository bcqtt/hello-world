 ...
 * */
@Service
public class GioneeSecurityMetadataSource implements FilterInvocationSecurityMetadataSource {
	protected static Logger logger = Logger.getLogger(GioneeSecurityMetadataSource.class);
	@Autowired
	...
	public Collection<ConfigAttribute> getAttributes(Object object) throws IllegalArgumentException {
		logger.info("-----------GioneeSecurityMetadataSource getAttributes ----------- ");
		String requestUrl = ((FilterInvocation) object).getRequestUrl();
		logger.info("GioneeSecurityMetadataSource:资源url----->" + requestUrl);
		if(resourceMap == null) {
			loadResourceDefine();
		}
