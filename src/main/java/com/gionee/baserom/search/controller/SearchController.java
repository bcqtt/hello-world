...
public class SearchController {
    ...
    public ModelAndView changeSource(Page<HotkeySource> page,HttpServletRequest request) {
		...
		page = hotkeySourceService.queryPage(page);
	...
	public ModelAndView addHotkeySourceView(String resKey,String editType) {
		ModelAndView model = new ModelAndView();
	...
	public ModelAndView editHotkeySourceView(String resKey,String editType,HotkeySource source) {
