...
public class HttpUtil {
    ...
    public static String sendGet(String url, String charset, String apiKey) {
        String result = "";
    ...
    public static String sendPostUrl(String url, String param, String charset, String apiKey) {
