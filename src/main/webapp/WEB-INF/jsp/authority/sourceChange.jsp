...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			...
			<li><a class="add" href="search/addHotkeySourceView?editType=add&resKey=${resKey}" target="dialog" width="600" height="280"><span>添加</span></a></li>
			<li><a class="edit" href="search/editHotkeySourceView?editType=update&id={id_source}&resKey=${resKey}" target="dialog" warn="请选择一个记录!" width="600" height="280"><span>修改</span></a></li>
