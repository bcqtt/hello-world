(function(e) {
    ...
    function a() {
        var t = img.parent("div").parent("li").prev();
        if (t.length == 0) t = e(".gallery li:last-child");
        t.find("a:first").trigger("click");
    }
    function f() {
    	console.log(img.parent("div"));
    	var t = img.parent("div").parent("li").next();
    ...
    (function() {
        ...
        e(document).keydown(function(e) {
            ...
            if (e.which == 27) l();
            if (e.which == 37 && !img.hasClass("zoom")) a();
            if (e.which == 39 && !img.hasClass("zoom")) f()
        });
        if (e(".gallery li .listimg a").length == 1) e(".gallery li .listimg a")[0].addClass("zoom");
        e(".zoom, .gallery li .listimg a").on("click", u)
    })(); (function() {
